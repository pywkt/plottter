...
def build_presets() -> list[Preset]:
    return [
        ...
        Preset(
            name="Edge Hug (horizontal lines)",
            params={
                "trace_supersample": 1,
                # Horizontal lines enter from the top edge and, where the wave
                # slows over dark pixels, crowd together and wrap around the
                # dark shapes. Gamma=2.0 strengthens the bunching in shadows;
                # linear spacing keeps the open top region evenly ruled.
                "mode": "FMM Topographic",
                "num_levels": 8,
                "spacing": "linear",
                "trace_threshold": 128,
